#ifndef EVOAI_LOSS_MEAN_SQUARED_ERROR_HPP
#define EVOAI_LOSS_MEAN_SQUARED_ERROR_HPP
...
namespace EvoAI{
   namespace Loss{
         ...
         */
        struct EvoAI_API MeanSquaredError{
            /**
...
#endif // EVOAI_LOSS_MEAN_SQUARED_ERROR_HPP